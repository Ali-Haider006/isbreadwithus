  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow">
        ...
        {/* ── Instagram ───────────────────────────────────────────────────── */}
        <section className="py-16 sm:py-24 bg-gradient-to-br from-[#3a4095] to-[#5a60b5]">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-8">
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3">Follow Along</h2>
              <p className="text-white/80 text-lg">Stay updated with our latest reads and events on Instagram.</p>
            </div>
            ...
            <div className="flex justify-center">
              <blockquote
                ...
                data-instgrm-permalink="https://www.instagram.com/p/DT7tWYpiHsD/?utm_source=ig_embed&utm_campaign=loading"
            ...
            <div className="mt-10">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white text-[#3a4095] px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition"
              >
